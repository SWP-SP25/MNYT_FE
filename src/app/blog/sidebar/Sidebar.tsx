...
const Sidebar = () => {
  ...
  // Placeholder cho số lượng bài viết và thành viên
  const totalPosts = 0; // Thay thế bằng API sau này
  const totalMembers = 0; // Thay thế bằng API sau này
    ...
    <div className={styles.sidebar}>
      ...
      <div className={styles.statsCard}>
        ...
        <div className={styles.statItem}>
          ...
          <strong>{totalPosts}</strong> {/* Chỗ để chèn API */}
        </div>
        <div className={styles.statItem}>
          <span>Thành viên:</span>
          <strong>{totalMembers}</strong> {/* Chỗ để chèn API */}
        </div>
      </div>
