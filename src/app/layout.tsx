...
export default function RootLayout({
  ...
  const excludedPaths = ["/login", "/register", "/forgotpassword", "/admin","/admin/blog","/admin/account","/admin/schedule-template","/admin/membership-plan","/admin/preganacy-standard"];
